...
import com.usermodule.service.SmsVerificationService;
...
public class VerificationResponse {
    ...
    public void verification(RegistrationRequest registrationRequest) {
        log.info("User {}", modelMapper.map(registrationRequest, User.class));
        String token = confirmationTokenService.emailOrMobileVerification(
...
//        String message = "\n Hello "+registrationRequest.getFirstName()+ "Please click on below link to verify "+link;
